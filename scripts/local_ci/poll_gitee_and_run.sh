...
GITEE_REPO_URL="${GITEE_REPO_URL:-https://gitee.com/likehupochuan/try-result.git}"
GITEE_OWNER="${GITEE_OWNER:-likehupochuan}"
GITEE_REPO="${GITEE_REPO:-try-result}"
GITEE_BRANCH="${GITEE_BRANCH:-ci/push/ci/base-ref-gateway-workers}"
